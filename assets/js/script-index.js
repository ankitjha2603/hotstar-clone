...
async function loadData() {
    let slideShowDataFetch = await fetch(`${window.location.href}assets/data/heading-presentation.json`);
    let showDataFetch = await fetch(`${window.location.href}assets/data/shows.json`);
